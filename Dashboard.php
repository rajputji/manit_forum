							...
							<div class="col-mod-5" >
								<form role="form" method="POST">
									<div class="form-group">
										<label>About</label>
										<input class="form-control" type="text" name="thread" placeholder="enter new thread" required />
                                    </div>
									<div class="form-group">
										<label>Description</label>
										<textarea class="form-control" rows="2" name="thread_description" placeholder="give some description about thread" required></textarea>
									</div>
									...
									<?php
										...
										while($row=$result->fetch_assoc()){
											...
											if(mysqli_num_rows($result1)==0)
											{
												...
												$owner = explode(' ',trim($row1['Faculty_Name']));	
											}
											else
											{
												$row1=$result1->fetch_assoc();
												$owner = explode(' ',trim($row1['Student_Name']));
											}
							              ...
							              $r = mysqli_fetch_assoc($res);
                                            ...
                                            <td>
												<div class='row' style='margin-left:0px; width:100%;'>
													...
													<div class='header'>";
														echo "<strong class='primary-font'>".$owner[0]." posted</strong>
