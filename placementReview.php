						...
						<div class="panel-body" style="margin-top:0px;">
						    <div class="col-mod-8" >
								<table class="table table-striped table-bordered">
									<tbody>
									<?php
										$query="SELECT * from placement_review ORDER BY Placement_Review_ID DESC LIMIT 5";
                                            ...
                                            <td>
												<div class='row' style='margin-left:0px; width:100%;'>
													...
													<div class='header'>";
														...
														//echo $arr[0];
														echo "<strong class='primary-font'>".$arr[0]." posted a placement review</strong>
													...
													echo "<a href='currentPlacementReview.php?review=".$row['Placement_Review_ID']."'>
														<p>";
							...
							<label><a href="allPlacementReview.php">See All</a></label>
						</div>
					</div>
				</div>
				<a href="newPlacementReview.php">
					<button type="submit" class="btn btn-info right-div">
						POST NEW <br>  PLACEMENT REVIEW</button>
				</a>
